...
- KEY USES BOTH WAYS (0.7.24, fund-critical): a switch reads the node being left; its highest per-key
  use m + 100 (KEYUSES_MARGIN, EVERY switch, owner's rule) is set on every key of the node being started
