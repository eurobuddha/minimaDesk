...
import { filePathOf, iconFor, install } from '../../../lib';
  ...
  const handleOnSubmit = async (evt: React.FormEvent) => {
    ...
    if (file) {
      ...
      try {
        ...
        // minimaDesk: the picked file already sits on disk — install straight from its absolute path
        const installedInfo = await install(filePathOf(file));
                        ...
                        {installed && (
                          <div className="text-center">
                            ...
                            <div
                              ...
                              style={{
                                backgroundImage: `url(${iconFor(installed.uid) || `${(window as any).MDS.filehost}${installed.uid}/${installed.conf.icon}`})`,
                              }}
                            />
                            <button
                              onClick={onClose}
