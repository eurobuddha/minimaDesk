/*
 * updater.js — minimaDesk learns about its own updates (ported from minimacore-desktop, 0.7.18) from a one-app store feed.
 *
 ...
 *   https://eurobuddha.com/pandaapps/minimadesk.json
 *   { "app": "minimaDesk", "version": "0.7.18", "date": "…", "notes": "…",
 *     "platforms": { "mac-arm64": { "file": "https://github.com/eurobuddha/minimaDesk/releases/download/v0.7.18/minimaDesk-0.7.18-arm64.dmg", "sha256": "…", "size": 154786107 }, "win-x64": {…}, "linux-x64": {…} } }
...
const DEFAULT_FEED = "https://eurobuddha.com/pandaapps/minimadesk.json";
...
function get(url, { timeout = 20000, maxRedirects = 5 } = {}) {
  return new Promise((resolve, reject) => {
    ...
    const req = mod.get(u, { headers: { "User-Agent": "minimaDesk/" + app.getVersion(), Accept: "*/*" }, timeout }, res => {
...
async function download() {
  ...
  const name = path.basename(u.pathname) || ("minimaDesk-" + status.version);
